...
```{r, fig.width=fig1.width, fig.height=fig1.height}
...
the reference strain which have not been associated with resistance. 95%CI.
...
to a particular drug. (KEEP REMOVE DETERMINE ->) For example, seven mutations
...
```{r, fig.width=fig3.width, fig.height=fig3.height}
...
associated with resistance.95%CI.

##MAP
Map of frequency of resistance per geographical area. 
